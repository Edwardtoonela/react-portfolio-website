...
const data = [
  ...
  },
  {
    avatar: AVTR4,
    name: 'Daniel Costa',
    review: `I met Ed at Le Wagon Rio, we've done a Full Stack Rails Development Bootcamp together. And at the end of the course, we worked together for the two final projects we had. One of which, was Ed's idea (Travel Tribe). I was happy and lucky to work with him. He's very driven and easy to work with. Has a good mindset, creative and smart when it comes to programming logic. Whatever he set himself to do, he did it really well. I'd be happy to work with people like Ed.`
  },
]
